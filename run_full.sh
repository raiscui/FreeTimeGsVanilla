...
CUDA_VISIBLE_DEVICES=2 python src/simple_trainer_freetime_4d_pure_relocation.py default_keyframe \
    ...
    --result-dir /data/shared/elaheh/mike_test_free_gs_60frames \
    --start-frame 0 \
    --end-frame 61 \
    --max-steps 50000 \
    --eval-steps 50000 \
